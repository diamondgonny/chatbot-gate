    ...
    <div className="min-h-screen flex flex-col items-center justify-center gap-8 p-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-2xl">
        ...
        >
          ...
          <h2 className="text-2xl font-semibold text-slate-200 mb-2">AI Chat</h2>
          <p className="text-slate-400">Talk to the Gatekeeper AI. Ask anything.</p>
        </Link>

        <div className="p-8 bg-slate-800/20 border border-slate-800 rounded-2xl opacity-50 cursor-not-allowed">
          <h2 className="text-2xl font-semibold text-slate-500 mb-2">Human Chat</h2>
          <p className="text-slate-600">Connect with other travelers. (Coming Soon)</p>
        </div>
      </div>
    </div>
  );
