    ...
    <div className="h-screen flex">
      ...
      <div className="flex-1 flex flex-col bg-slate-900">
        ...
        <div className="flex-1 overflow-y-auto p-4 scrollbar-custom">
          ...
          ) : messages.length === 0 && !pendingMessage && !isProcessing ? (
                        ...
                        <div className="space-y-4">
                          ...
                          {message.wasAborted && (
                            <div className="bg-red-900/20 border border-red-700/30 rounded-lg px-4 py-2 flex items-center gap-2">
                              ...
                              <span className="text-red-400 text-sm">Generation stopped - partial results</span>
                            </div>
                          )}
                ...
                >
                  ...
                  {wasAborted && !isProcessing && (
                    <div className="bg-red-900/20 border border-red-700/30 rounded-lg px-4 py-2 flex items-center gap-2">
                      ...
                      <span className="text-red-400 text-sm">Generation stopped - partial results shown below</span>
                    </div>
                  )}
                  ...
                  <AnimatePresence>
                    ...
                    {(stage3Synthesis || stage3StreamingContent || stage3ReasoningContent || currentStage === "stage3") && (
                      <Stage3Panel
                        key="stage3-panel"
        ...
        {isProcessing && (
          <div className="border-t border-slate-800 p-4">
            <div className="max-w-4xl mx-auto flex justify-center">
              <button
                onClick={() => abortProcessing(sessionId)}
